...
{
    /// <summary>
    /// Non thread-safe in the sense where multiple threads are writing or reading at the same time is not allowed.
    /// Only one single thread can write, and another one can read at the same time.
    /// </summary>
    public class AwaitableCircularBuffer<T>
    {
        ...
        /// <summary>
        /// Contains the amount of data that could not be written because there was no room left
        /// </summary>
        public long LostData { get; private set; }
        #endregion
